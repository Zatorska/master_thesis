...
\subsubsection{Opis danych surowych}
...
\begin{itemize}
    ...
    \item \textbf{CountryCode:} Kody krajów zgodne z normami ISO, identyfikujące poszczególne kraje.
\end{itemize}

Jest to główny plik, zawierający wszystkie dane niezbędne do wykonania przeprowadzonych w tej pracy analiz i predykcji. Poniżej przedstawiono przykładowe wartościu, po konwersji pliku na tabelę \textbf{<dodać przykładową tabelę>}. 

W pliku odnotowano łącznie \textbf{X} rekordów, które stanowią dane dla następujących krajów Unii Europejskiej: Austrii, Chorwacji, Cypru, Czech, Danii, Estonii, Finlandii, Francji, Niemiec, Grecji, Węgier, Irlandii, Włoch, Łotwy, Litwy, Luksemburga, Polski, Portugalii, Rumunii, Słowacji, Słowenii, Hiszpanii i Szwecji. 
...
Plik ten jest słownikiem mapującym kody krajów na ich pełne nazwy w języku angielskim, który przedstawiono poniżej \textbf{<wczytać tabelę>}. Oryginalnie znajdował sie w formacie CSV z separatorem w formie przecinka.


Jak widać na tabeli X, skłąda się ona z poniższych kolumn:
\begin{itemize}
    \item \textbf{CountryCode:} Zawiera kody krajów zgodne z normami ISO, zastosowane w pliku entsoe\_country.csv w kolumnie CountryCode,
