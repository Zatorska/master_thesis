...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{./out_figures/figure_2}
  \end{subfigure}
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{./out_figures/figure_3}
  \end{subfigure}
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{./out_figures/figure_4}
  \end{subfigure}
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{./out_figures/figure_5}
  \end{subfigure}
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{./out_figures/figure_6}
  \end{subfigure}
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{./out_figures/figure_7}
  \end{subfigure}
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{./out_figures/figure_8}
  \end{subfigure}
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{./out_figures/figure_9}
  \end{subfigure}
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{./out_figures/figure_10}
  \end{subfigure}
...
\todo[inline]{Tutaj krótki opis struktury pracy, typu: w tym rozdziale to to a w tamtym to tamto.}

% --- chapter ---------------------------------------------------------
\clearpage
\section{Wykorzystane dane}

\todo[inline]{Uzupełnić o krótki wstęp.}
...
Pierwszy z wykorzystanych plików o nazwie \code{entsoe_country.csv}. Plik ten zawiera następujące zmienne:
...
\begin{table}[hbt]
  ...
  \caption[xxx]{Przykładowe obserwację z głównego pliku z danymi. \textit{Źródło:} opracowanie własne.}
  \label{tab:tabela1}
...
Plik ten jest słownikiem mapującym kody krajów na ich pełne nazwy w języku angielskim, który przedstawiono poniżej (tabela 2). Oryginalnie znajdował się w formacie CSV z separatorem w formie przecinka.
...
\begin{table}[hbt]
  ...
  \caption[xxx]{xxx \textit{Źródło:} opracowanie własne.}
  \label{tab:tabela2}
...
Jak jak można zaobserwować na tabeli~\ref{tab:tabela2}, składa się ona z poniższych kolumn:
\begin{itemize}
...
\subsection{Wstępne przygotowanie danych}
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[t]{0.95\textwidth}
    \includegraphics[width=\textwidth]{./out_figures/actual_electricity_consumption_Austria.png}
  \end{subfigure}

  \captionsetup{margin=10pt,font=small,labelfont=bf,width=.8\textwidth}

  \caption[Zużycie energii elektrycznej na Cyprze, w okresie od 2016-09-22 do 2021-08-30. Dane zagregowane do tygodnia.]{Wzrost cen nośników energii w ujęciu nominalnym i realnym w latach 2002–2021 w Polsce. \textit{Źródło:} opracowanie własne}\label{fig:x11}
\end{figure}
